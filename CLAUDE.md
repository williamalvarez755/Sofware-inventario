...
>
> **Verificación:** 132 pruebas en el API y 11 en la web, todas en verde; compilación de producción correcta. En navegador: ingreso con usuario, cambio de tema aplicándose al instante en toda la interfaz, y venta completa de Q13.50 con Q20.00 recibidos → cambio Q6.50 y comprobante No. 128.
>
...
| D-040 | 2026-08-01 | Iconos SVG propios, **cero emojis**, en estilo **dúotono** (silueta rellena al 18 % + trazo) | En Windows los emojis se pintan con su propia paleta, que ningún tema puede corregir. El dúotono da volumen y calidez donde un pictograma de línea se ve genérico y frío, y sigue legible a 16 px, que es el tamaño de la barra. |
